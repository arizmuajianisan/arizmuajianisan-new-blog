...
I have a habit I can’t fully control—one that automatically kicks in: *multitasking*. For example, while working on Task A, certain parts of it remind me of Task B, instantly distracting me and shifting my focus to Task B. This can branch out further to Tasks C, D, and beyond. Right now, as I type this post, I’m technically juggling two different tasks. Then, a thought pops into my head: *“Why am I working on these two things at once?”* Oh, wait—now it’s three! All while I’m checking the terminal for an ongoing environment installation.
